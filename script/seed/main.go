...
func main() {
	...
	if args[0] == "up" {
		seedFiles = []string{
			"migrations/seed/000004_seed_plant_varieties.up.sql",
			"migrations/seed/000005_seed_planting_cycles.up.sql",
		}
	}
	if args[0] == "down" {
		seedFiles = []string{
			"migrations/seed/000005_seed_planting_cycles.down.sql",
			"migrations/seed/000004_seed_plant_varieties.down.sql",
		}
	}
