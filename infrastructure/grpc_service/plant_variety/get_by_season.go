...
func (s *PlantVarietyService) GetPlantVarietiesBySeason(ctx context.Context, req *plantVarietyP.GetPlantVarietiesBySeasonRequest) (*plantVarietyP.ListPlantVarietiesResponse, error) {
	plantVarieties, err := s.getBySeasonUsecase.Execute(ctx, req.Season)
	if err != nil {
		return nil, err
	}
