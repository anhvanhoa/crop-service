...
func (s *PlantVarietyService) GetPlantVarietiesByHumidityRange(ctx context.Context, req *plantVarietyP.GetPlantVarietiesByHumidityRangeRequest) (*plantVarietyP.ListPlantVarietiesResponse, error) {
	plantVarieties, err := s.getByHumidityRangeUsecase.Execute(ctx, req.MinHumidity, req.MaxHumidity)
	if err != nil {
		return nil, err
	}
